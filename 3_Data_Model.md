...
Optionally, the FHIR Bundle can include other structured data items such as NEWS2 Scores, and/or the individual observations necessary to calculate the NEWS2 Score (FHIR Observation resources). See Section 1.2 of this implementation guidance for an overview of the suggested PDF content. 
